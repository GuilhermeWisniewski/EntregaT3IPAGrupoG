...
void credits_call(void)
{
    ...
    char creditos[][50]={"CREDITOS","DESENVOLVIMENTO","Guilherme dos Santos Wisniewski 813319","Gabriel Vianna de Oliveira Spolon 811649","Sergio Felipe Bezerra Rabelo 812205","Joao Vitor Amaral da Silva 790287","BACKGROUND", "jeruu (itch.io)","black-canvas (itch.io)","SPRITES","craftpix.net","nyknck (itch.io)","frodoundead (itch.io)","ninjikin (itch.io)","MUSICA E SONS","Jonathan So","Cici Fyre","RAYLIB"};
